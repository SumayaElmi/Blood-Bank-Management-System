...
import { FaUserCircle } from "react-icons/fa"; // Tallaabada 1: Soo deji icon-ka
    ...
    <div>
      ...
      <div className="dashboard-layout-row" style={{ gridTemplateColumns: '1fr 2fr' }}>
        <div className="card profile-card">
          {/* Tallaabada 2 & 3: Beddel img tag-ka */}
          <div className="profile-avatar-wrapper" style={{ display: 'flex', justifyContent: 'center', marginBottom: '15px' }}>
            <FaUserCircle
              className="profile-avatar"
              style={{
                fontSize: "120px", // Weynee icon-ka si uu ugu ekaado avatar
                color: "#356BB3",
                borderRadius: '50%',
